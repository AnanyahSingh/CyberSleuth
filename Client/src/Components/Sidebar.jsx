  ...
  return (
    <div className="flex flex-col justify-between w-[250px] bg-[#282c34] p-4">
      ...
      <div className="flex flex-col mt-12 h-[70%] text-[#5041BC]">
        ...
        <NavLink
          className="flex gap-3 text-white py-3 rounded-lg items-center justify-center"
          to="/archivedcases"
        >
          <i className="fas fa-archive"></i>
          <span className="text-white">Archived Cases</span>
        </NavLink> 

        <NavLink className="flex gap-3 text-white py-3 rounded-lg items-center justify-center" to="/newCases">

          <i className="fas fa-archive"></i>
          <span className="text-white">Add New Case</span>
        </NavLink>
